...
<div class="content clearfix">
    ...
    <div class="contRight fr">
    	<div class="exportW borderC tabs1">
        	<ul class="tab_menu studyTit clearfix">
                <li class="current"><a href="javascript:;">心理学专家</a></li>
                <li><a href="javascript:;">易经专家</a></li>
            </ul>
            <div class="tab_box">
            	<div class="">
                	<ul class="exList">
                        <asp:DataList ID="DataList2" runat="server">
                            <ItemTemplate>
                            <li class="clearfix">
                        	<div class="exportImg fl">
                            	<a href="#"><img src="" width="100" height="125" /></a>
                            </div>
                            <div class="exportInfo fl">
                            	<h4><a href="#"><%#Eval("EXPERTNAME") %></a></h4>
                                <div class="exJob"><%#Eval("TYPENAME") %></div>
                                <div class="detInfo">
                                	<%#Eval("EXPERTDES") %>
                                </div>
                            </div>
