...
<script runat="server">
	...
	/**
	 * This function must check the user Response.Cookies["User"] to be sure that he/she is
	...
	private bool CheckAuthentication()
	{
		...
		// some kind of Response.Cookies["User"] validation here. Even something very simple as...
		//
		//		return ( Response.Cookies["User"][ "IsAuthorized" ] != null && (bool)Response.Cookies["User"][ "IsAuthorized" ] == true );
		//
		// ... where Response.Cookies["User"][ "IsAuthorized" ] is set to "true" as soon as the
