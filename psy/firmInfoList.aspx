<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="firmInfoList.aspx.cs" Inherits="firmInfo" %>
...
<div class="content clearfix">
	<div class="leftNav fl">
        ...
        <div class="lnList">
         ...
         <div class="lnList">
        	<a  class="on" href="firmInfoList.aspx">我发布的招聘信息</a>
        </div>
        <div class="lnList">
