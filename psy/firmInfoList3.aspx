<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="firmInfoList3.aspx.cs" Inherits="firmInfo" %>
...
<div class="content clearfix">
	<div class="leftNav fl">
        ...
        <div class="lnList">
        	<a class="on" href="firmInfoList3.aspx">我发送的邀请函</a>
        </div>
    </div>  
      <div class="rightMain fr">
    	<ul class="studyTit clearfix">
            <li class="current"><a href="javascript:;">我发送的邀请函</a></li>
        </ul>
        <div class="rmCont">
